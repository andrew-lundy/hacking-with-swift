...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func createScore() {
        ...
        scoreLabel.position = CGPoint(x: frame.maxX - 90, y: frame.maxY - 60)
    ...
    func createBackground() {
        ...
        for i in 0...1 {   
            ...
            background.position = CGPoint(x: (backgroundTexture.size().width * CGFloat(i)), y: 100)
            addChild(background)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        // Avoid any collisions where either node is nil
