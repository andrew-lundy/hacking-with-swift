...
//  Project17
//
//  Created by Andrew Lundy on 11/6/19.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    @objc func createEnemy() {
        ...
        // Challenge 2
        currentEnemies += 1
        if currentEnemies == 20 {
            timerTime -= 0.1
            gameTimer?.invalidate()
            gameTimer = Timer.scheduledTimer(timeInterval: timerTime, target: self, selector: #selector(createEnemy), userInfo: nil, repeats: true)
        }
    }
